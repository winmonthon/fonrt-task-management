  ...
  <div class="mt-5  ">
    ...
    <div v-for="(task,i) in tasks" :key="i" class="mobile-table">
      ...
      <div class="d-flex justify-content-between my-1">
        ...
        <div>
          <button type="button" @click="updateTask(i)" class="mx-1 btn btn-sm btn-outline-secondary">Update</button>
          <button type="button" @click="finishTask(i)" class=" mx-1 btn btn-sm btn-success">Finish</button>
        </div>
