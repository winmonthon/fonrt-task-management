<template>
  <div class="px-5">
    <div class="mt-5  ">
      <h1 class="mb-4 text-center">Tasks</h1>asdas
      <div>
        <button
      ...
      <div class="fliter-input-mobile mb-3">
        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200" for="">ค้นหาด้วนสถานะ</label>
      ...
      <div v-for="(task, i) in tasks" :key="i" class="mobile-table">
        ...
        <div class="flex justify-between my-1">
          ...
          <div>
            ...
            <button type="button" @click="finishTask(i)"
              class="px-2 py-1 text-sm tracking-wide text-white transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-green-400 focus:outline-none focus:bg-green-400 focus:ring focus:ring-green-300 focus:ring-opacity-50">
              Finish
            </button>
          </div>
        </div>
